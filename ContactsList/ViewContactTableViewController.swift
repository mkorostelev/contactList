...
//            labelLastName?.text = selectedContact.lastName
            labelTitle?.title = selectedContact.fullName
            
            labelPhone?.text = selectedContact.phoneNumber
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "editContact" {
            ...
            if let toNavController = segue.destination as? EditNavigationViewController {
                if let toViewController = toNavController.viewControllers.first as? NewContactViewController {
